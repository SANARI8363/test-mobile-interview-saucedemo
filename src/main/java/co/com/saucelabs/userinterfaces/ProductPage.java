...
public class ProductPage {
    ...
    public static final Target BTN_ADD_TO_CART = Target.the("Button AÑADIR A CARRITO").located(By.xpath("(//android.view.ViewGroup[@content-desc=\"test-AÑADIR A CARRITO\"])[1]/android.widget.TextView"));
    public static final Target BTN_BACK_TO_HOME= Target.the("Button Back to the Home").located(By.xpath("//android.view.ViewGroup[@content-desc=\"test-CONTINUAR COMPRANDO\"]"));
